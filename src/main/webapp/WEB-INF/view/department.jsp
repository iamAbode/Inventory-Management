...
<html lang="en">
   ...
   <div class="modal-footer">
    ...
    <li><a href="javascript:void(0);" class="glyphicon glyphicon-plus" id="addLink" onclick="javascript:$('#addUser').slideToggle();">Add</a>
           ...
           <div class="panel-body formData" id="addUser" style="display:none">
                <h2 id="actionLabel">Create Department</h2>
         ...
         <div class="panel-body formData" id="editForm" style="display:none">
                ...
                <form class="form" id="userForm"> 
                    ...
                    <a href="javascript:void(0);" class="btn btn-success" onclick="userAction('edit')">Update Department</a>
               		</div>
                </form>
            </div>
 ...
 if (confirm("Do you want to "+type+" department?. Click OK to Continue or Cancel to ignore") === true) {    
    ...
    $.ajax({
        ...
        if($.trim(msg) === "ok"){
                alert('Department '+statusArr[type]+' successfully.'); 
