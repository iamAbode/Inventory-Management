...
<html lang="en">
   ...
   <div class="modal-footer">
    ...
    <li><a href="javascript:void(0);" class="glyphicon glyphicon-plus" id="addLink" onclick="javascript:$('#addUser').slideToggle();">Add</a>
           ...
           <div class="panel-body formData" id="addUser" style="display:none">
                <h2 id="actionLabel">Create Category</h2>
 ...
 if (confirm("Do you want to "+type+" category?. Click OK to Continue or Cancel to ignore") === true) {    
    ...
    $.ajax({
        ...
        if($.trim(msg) === "ok"){
                alert('Category '+statusArr[type]+' successfully.'); 
