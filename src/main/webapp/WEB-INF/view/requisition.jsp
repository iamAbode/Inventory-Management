...
<html lang="en">
     ...
     <div class="panel panel-default users-content">          
         ...
         <div class="panel-body formData" id="addUser" style="margin-top:-30px">
                    ...
                    <div class="panel-body">
                        <div class="row" id="product_show">
                            ...
                            <div class="col-md-12 col-sm-12">
                              ...
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <small id="bonus_percent" style="display:none"> </small>
                                            </div> <br />
            ...
            <aside class="col-md-5" style="margin-top:-50px">
                ...
                <!-- Cart submit form -->
                <form action="<%= request.getContextPath() %>/Show-Requisition" method="POST"> 
                    <!-- SmartCart element -->
 ...
 function getAllItems(){     	
  ...
  $("#product_cat").append("<option value='"+data[i].code+":"+data[i].name+":"+data[i].category+":"+data[i].price+":"+data[i].balance+" in stock'>"+ data[i].name +"</option>");
