 ...
 <div class="modal-dialog modal-lg">
  <div class="modal-content">
   ...
   <div class="modal-footer">
    ...
    function searchFilter() {  //alert("it got the id "+$("#req_id").val());          
        var id = $("#req_id").val(); 
        var url2 = $("#url_id").val();  
        
       $.ajax({
            type: 'POST',            
            url: url2+'/api/findbyreqid',
            data:'id='+id,
            beforeSend: function () { 
    ...
    function submit(id,st){ 
    	var url2 = $("#url_id").val();
    	var status = {S:"Submitted", A:"Received"};
	    $.ajax({
	        type: 'GET',	        
	        url: url2+'/api/upreq/'+id+"/"+st,
	        data: 'id='+id,
	        beforeSend: function () { 
                $('.loading-overlay').show();
            },
	        success:function(data){  	            
	        if($.trim(data) === "ok"){ 	        	
	        	alert("Requisition "+status[st]+" successfully");
	        	$("#addUser").hide();
	        }
	        else{
