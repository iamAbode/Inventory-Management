...
public class Pagination
{
    ...
    public Pagination(Map params){
        if (params.size() > 0){  
           ...
           //System.out.println("Totalpage:"+this.totalRows+" perPage:"+this.perPage+" currentPage:"+this.currentPage+" filter:"+this.filter);
        }
    ...
    public String paginate(){ 
        ...
        numPages = Math.round(this.totalRows / this.perPage);
